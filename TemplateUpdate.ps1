...
$packageList = "Npgsql", "Magenic.Maqs", "Magenic.Maqs.NunitOnly", "Magenic.Open.Maqs", "Magenic.Open.Maqs.NunitOnly", "Magenic.Maqs.SpecFlow", "Newtonsoft.Json", "Selenium.WebDriver", "Selenium.Support", "Castle.Core", "MailKit", "MimeKit",  "NUnit",  "NUnit3TestAdapter", "Selenium.WebDriver.ChromeDriver", "Selenium.WebDriver.GeckoDriver", "Selenium.WebDriver.GeckoDriver.Win32", "Selenium.WebDriver.IEDriver", "Selenium.WebDriver.MicrosoftDriver", "Appium.WebDriver",  "MSTest.TestAdapter", "MSTest.TestFramework"
$versionList = "4.0.3", $maqsVer,        $maqsVer,                 $maqsVer,            $maqsVer,                      $maqsVer,               "11.0.2",          "3.14.0",              "3.14.0",          "4.3.1",       "2.0.4",   "2.0.4",    "3.10.1", "3.10.0",            "2.42.0.1",                        "0.22.0",                         "0.22.0",                               "3.14.0",                      "17.17134.0",                         "4.0.0.3-beta",      "1.3.2",              "1.3.2"
